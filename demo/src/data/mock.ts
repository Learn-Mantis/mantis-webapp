...
export const heatmap = Array.from({ length: 70 }, (_, i) => ({
  day: i,
  intensity: Math.floor(Math.random() * 5),
}))

export const recentBattles = [
  { opponent: 'Ananya R.', result: 'win' as const, ratingChange: 18, time: '20m ago', score: '8-5' },
  { opponent: 'Rohit K.', result: 'win' as const, ratingChange: 22, time: '2h ago', score: '10-6' },
  { opponent: 'Priya S.', result: 'loss' as const, ratingChange: -14, time: '5h ago', score: '6-9' },
  { opponent: 'Dev M.', result: 'win' as const, ratingChange: 16, time: '1d ago', score: '9-7' },
]

export const leaderboard = [
  { rank: 1, name: 'Aarav Sharma', rating: 2340, college: 'AIIMS Delhi' },
  { rank: 2, name: 'Ishaan Gupta', rating: 2298, college: 'JIPMER' },
  { rank: 3, name: 'Kavya Reddy', rating: 2255, college: 'CMC Vellore' },
  { rank: 8, name: 'Rudransh Nareda', rating: 1842, college: 'Your College', you: true },
]
