...
const quickActions = [
  ...
  { label: 'Browse Community', icon: Globe, tone: 'brand', reason: 'browse community decks' },
] as const
    ...
    <PageContainer>
          ...
          <div className="flex flex-col gap-3">
            <div>
              ...
              <p className="text-2xl font-extrabold font-[var(--font-display)] mt-0.5">
                {totalDue} <span className="text-sm font-medium text-neutral-400">cards due</span>
              </p>
            </div>
        ...
        <div className="grid grid-cols-4 gap-2.5">
          {quickActions.map((a) => (
            <button key={a.label} onClick={() => requireAuth({ reason: a.reason })} className="text-left">
              <Card interactive className="flex flex-col items-center justify-center gap-2 py-4 px-1.5 text-center h-full">
      ...
      <Card className="relative overflow-hidden p-5 bg-gradient-to-br from-info-500 to-info-600 border-0 text-white">
        ...
        <Button
          size="md"
          variant="secondary"
          className="w-full mt-4 bg-white !text-info-600"
